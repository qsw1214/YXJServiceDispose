...
import com.youxianji.facade.groupbuy.bean.GetGroupbuyProdDetailRequestBean;
import com.youxianji.facade.groupbuy.bean.GetGroupbuyProdDetailResponseBean;
...
@Facade(command="3015",comment="获取商品详情")
@Scope("prototype")
public class GetGroupbuyProdDetailFacade extends AbsFacade{
	...
	public BaseResponse execute(BaseRequest baseRequest) {
		GetGroupbuyProdDetailRequestBean requestBean = (GetGroupbuyProdDetailRequestBean)baseRequest;
		GetGroupbuyProdDetailResponseBean responseBean = new GetGroupbuyProdDetailResponseBean();
		...
		if(groupbuy == null){
			...
			if(groupbuyDetail!=null){
					...
					responseBean.setSpecialFlag(groupbuyDetail.getSpecialFlag());
			}	
		}
