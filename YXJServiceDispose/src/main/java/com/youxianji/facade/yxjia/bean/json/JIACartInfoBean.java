...
public class JIACartInfoBean {
	...
	private List<JIAProdTagsBean> prodtagslist;//商品显示标签
	...
	public List<JIAProdTagsBean> getProdtagslist() {
		return prodtagslist;
	}
	public void setProdtagslist(List<JIAProdTagsBean> prodtagslist) {
