...
import com.youxianji.util.wechat.common.MD5;
import com.youxianji.util.wechat.common.Util;
import com.youxianji.util.wechat.common.XMLParser;
...
public class AppSignature {
    ...
    public static String getSign(Object o) throws IllegalAccessException {
        ...
        result += "key=" + AppConfigure.getKey();
    ...
    public static String getSignMap(Map<String,String> map){
        ...
        String result = sb.toString();
        result += "key=" + AppConfigure.getKey();
        System.out.println("MAP Sign Before MD5:" + result);
        //Util.log("Sign Before MD5:" + result);
        result = MD5.MD5Encode(result).toUpperCase();
        //Util.log("Sign Result:" + result);
        return result;
    ...
    public static String getSignFromResponseString(String responseString) throws IOException, SAXException, ParserConfigurationException {
        ...
        return AppSignature.getSign(map);
    }
    ...
    public static boolean checkIsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException, SAXException {
        ...
        map.put("sign","");
        //将API返回的数据根据用签名算法进行计算新的签名，用来跟API返回的签名进行比较
        String signForAPIResponse = AppSignature.getSign(map);
