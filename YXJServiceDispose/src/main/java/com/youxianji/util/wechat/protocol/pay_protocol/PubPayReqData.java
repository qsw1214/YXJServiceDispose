package com.youxianji.util.wechat.protocol.pay_protocol;
...
public class PubPayReqData {
     ...
     */
    public PubPayReqData(String appid,String mchid,String openid,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String notifyUrl,String tradeType){
